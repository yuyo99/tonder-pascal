...
function GapQueueTab() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-1">Knowledge Gap Queue</h3>
      <p className="text-sm text-gray-500 max-w-md mx-auto">
        When Pascal encounters questions it can&apos;t answer, they&apos;ll appear here.
        You can review gaps and turn them into knowledge entries.
      </p>
      <p className="text-xs text-gray-400 mt-4">Coming in AID-80</p>
    </div>
  );
}
