  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">People Knowledge Base</h1>
          <p className="text-sm text-gray-400 mt-0.5">
            Team members, merchant contacts, and escalation paths
          </p>
        </div>
        <button
          onClick={() => openNew(tab === "merchants" ? "merchant_contact" : "tonder_team")}
          className="px-4 py-2 bg-violet-500 text-white text-sm font-medium rounded-lg hover:bg-violet-600 transition-colors shadow-sm"
        >
          + Add Person
        </button>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {stats.map((s) => (
          <div
            key={s.label}
            className={`bg-white rounded-xl border border-gray-100 border-l-2 ${s.accent} p-5`}
          >
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-3 py-2 text-sm border border-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 w-64 placeholder:text-gray-300"
          />
        </div>
      </div>
