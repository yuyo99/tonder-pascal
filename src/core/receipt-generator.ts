...
export async function generateRefundReceipt(data: ReceiptData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.text(
        "La solicitud de reembolso se procesó con éxito. " +
        "El tiempo en el que los fondos se reflejan en tu cuenta depende de tu banco emisor.",
